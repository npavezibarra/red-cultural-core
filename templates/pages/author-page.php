...
<head>
    ...
    <style>
        ...
        #author-page-wrapper { min-height: 60vh; }
    </style>
    <?php wp_head(); ?>
</head>
<body <?php body_class('selection:bg-black selection:text-white'); ?>>
    ...
    <div id="author-page-wrapper" class="max-w-3xl mx-auto px-6 py-8 md:py-16">
            ...
            <div class="flex-grow">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-zinc-500 mb-2 text-sm md:text-base"><?php echo esc_html($author_job); ?></p>
                    </div>
                    <!-- Socials -->
                ...
                <p class="text-sm md:text-base leading-snug text-zinc-800 max-w-lg mt-2">
