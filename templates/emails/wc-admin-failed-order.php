<?php
/**
 * Custom WooCommerce Admin Failed Order Email Template
 *
 * @var WC_Order $order
 */
if (!defined('ABSPATH')) {
...
<head>
    ...
    <title>Red Cultural - Pedido Fallido #<?php echo esc_html($order_number); ?></title>
    <style>
        ...
        .pill { display:inline-block; font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.12em; background:#fff7ed; color:#9a3412; padding: 6px 10px; border-radius: 999px; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <span class="pill">Pedido Fallido</span>
        ...
        <div class="content">
            <p class="muted">Este pedido fue marcado como <strong>fallido</strong> (pago rechazado / no completado).</p>
            <table class="receipt">
